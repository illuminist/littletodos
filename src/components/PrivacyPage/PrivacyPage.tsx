  ...
  return (
    <Container maxWidth="md" className={clsx(className, classes.root)}>
      ...
      <Typography variant="body1" paragraph>
        Witsarut Sawetkanit built the Little Todos app as an Open Source app.
        This SERVICE is provided by Witsarut Sawetkanit at no cost and is
      ...
      <Typography variant="body1" paragraph>
        ...
        but not limited to country by region. The information that I request
      ...
      <Typography variant="body1" paragraph>
        ...
        <ExternalLink component={Link} href="https://github.com/illuminist">
      ...
      <Typography variant="body1" paragraph>
        ...
        <ExternalLink component={Link} href="https://privacypolicytemplate.net">
